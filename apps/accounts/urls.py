...
from .views import (
    ...
    admin_system_log, admin_category_list, admin_dead_emails, admin_health_dashboard, admin_ai_audit_log, admin_override_classification,
...
urlpatterns = [
    ...
    path("admin-panel/ai-audit/", admin_ai_audit_log, name="admin_ai_audit_log"),
    path("admin-panel/reports/<int:report_id>/override/", admin_override_classification, name="admin_override_classification"),
    path(
        "password-reset/",
